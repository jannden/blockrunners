        ...
        <div className="space-y-4">
          <div>
            ...
            <p className="text-sm mt-1">
              Navigate through the neon-lit streets of the cyberpunk city by choosing your path.
              Each move costs ciphers, which are the game's currency.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="text-sm mt-2 space-y-3 pl-2">
              ...
              <li className="flex items-center">
                ...
                <div>
                  <span className="font-bold">Doubler</span> - The next correct step awards two
                  random cards instead of one.
                </div>
              </li>
              <li className="flex items-center">
          ...
          <div>
            ...
            <p className="text-sm mt-1">
              Select cards before making a move to activate their effects. Each selected card
              increases the cost of your next move by 1 cipher. You can select multiple cards for a
              single move.
            </p>
          </div>
        </div>
